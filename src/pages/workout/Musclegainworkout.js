...
function Musclegainworkout(workoutProp) {
  return (
    <>
    <h1 className='header-name'>MUSCLEGAIN WORKOUT - THERE IS NO LIMIT...</h1>
    <div className='workout-container'>
      {
        workoutProp.musclegainWorkout.map((data,i)=>{
          return (
...
export default Musclegainworkout