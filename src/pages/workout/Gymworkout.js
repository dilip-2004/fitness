...
function Gymworkout(workoutProp) {

  return (
    <>
    <h1 className='header-name'>GYM WORKOUT - THERE IS NO LIMIT...</h1>
    <div className='workout-container'>
      {
        workoutProp.gymWorkout.map((data,i)=>{
          return (
                ...
                data.ex.map((data2,i)=>{
                  return(
                    <div className='workout-details'>
                      <img className='workout-image' src={fs1} alt='' />
                      <p>{data2}</p>
